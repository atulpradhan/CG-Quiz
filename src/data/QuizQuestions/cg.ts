...
export const cg: Topic = {
  ...
  questions: [
    ...
    {
    question: 'नियाद नेल्लनार योजना का अर्थ क्या है?',
...
{
    question: 'नियाद नेल्लनार योजना का नाम किस स्थानीय भाषा से लिया गया है?',
...
{
    question: 'नियाद नेल्लनार योजना का उद्देश्य क्या है?',
    choices: ['शिक्षा को बढ़ावा देना', 'गांवों में सुविधा और लाभ प्रदान करना', 'किसानों को सहायता देना', 'युवाओं के लिए रोजगार प्रदान करना'],
    type: 'MAQs',
    correctAnswers: ['गांवों में सुविधा और लाभ प्रदान करना'],
    score: 5,
},
{
...
{
    question: 'मुख्यमंत्री कन्या उत्थान योजना का मुख्य उद्देश्य क्या है?',
    choices: ['कन्याओं की शिक्षा को बढ़ावा देना', 'गरीब परिवारों की कन्याओं के विवाह में आर्थिक सहायता प्रदान करना', 'स्वास्थ्य सेवाएं प्रदान करना', 'रोजगार के अवसर बढ़ाना'],
    type: 'MAQs',
    correctAnswers: ['गरीब परिवारों की कन्याओं के विवाह में आर्थिक सहायता प्रदान करना'],
    score: 5,
},
{
    question: 'मुख्यमंत्री कन्या उत्थान योजना के तहत कितनी कन्याओं को प्रति परिवार सहायता दी जा सकती है?',
    choices: ['एक कन्या', 'दो कन्याएं', 'तीन कन्याएं', 'चार कन्याएं'],
    type: 'MAQs',
    correctAnswers: ['दो कन्याएं'],
    score: 5,
},
{
    question: 'मुख्यमंत्री कन्या उत्थान योजना के तहत प्रत्येक कन्या के विवाह के लिए अधिकतम कितनी राशि खर्च की जा सकती है?',
    choices: ['10,000 रुपये', '15,000 रुपये', '25,000 रुपये', '30,000 रुपये'],
    type: 'MAQs',
    correctAnswers: ['25,000 रुपये'],
    score: 5,
},
{
    question: 'मुख्यमंत्री कन्या उत्थान योजना के तहत किस परिवार के सदस्य इस सहायता का लाभ उठा सकते हैं?',
    choices: ['गरीबी रेखा से ऊपर जीवन यापन करने वाले', 'गरीबी रेखा से नीचे जीवन यापन करने वाले', 'सभी परिवार', 'विशेष जनजाति समुदाय के सदस्य'],
    type: 'MAQs',
    correctAnswers: ['गरीबी रेखा से नीचे जीवन यापन करने वाले'],
    score: 5,
},
{
    question: 'मुख्यमंत्री कन्या उत्थान योजना के तहत वधु को कितनी राशि बैंक ड्राफ्ट के ज़रिए दी जाती है?',
    choices: ['1,000 रुपये', '5,000 रुपये', '10,000 रुपये', '14,000 रुपये'],
    type: 'MAQs',
    correctAnswers: ['1,000 रुपये'],
    score: 5,
},
